...
export class LicenciaturaService {
  ...
  create(Licenciatura: Licenciatura): Observable<Licenciatura> {
    return this.http.post<Licenciatura>(
      `${this.path}/api/v1/licenciatura`,
      Licenciatura
    );
  }

  findById(id: number): Observable<Licenciatura> {
    return this.http.get<Licenciatura>(
      `${this.path}/api/v1/licenciaturas/${id}`
    );
  }
  ...
  update(id: number, Licenciatura: Licenciatura): Observable<any> {
    return this.http.put<any>(
      `${this.path}/api/v1/licenciatura/${id}`,
      Licenciatura,
      {
        observe: 'response',
      }
